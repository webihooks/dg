      ...
      <script>
         ...
         function scrollToSection(sectionClass) {
             ...
             if (section) {
                 ...
                 // Calculate position with 200px offset from top
   ...
   <body class="restaurant">
      <div class="main">
         ...
         <div id="menuOverlay" class="menu-overlay">
            ...
            <a href="javascript:void(0)" onclick="scrollToSection('qr_code_details')">QR Code</a>
            <a href="javascript:void(0)" onclick="openEnquiryPopup()">Send Address</a>
         </div>
         <script>
            function toggleMenu() {
                const burger = document.querySelector('.burger-menu');
         ...
         <div class="products">
            ...
            <div class="row" id="productsContainer">
               ...
               <div class="col-sm-12 product-item" 
                  ...
                  data-desc="<?php echo htmlspecialchars(strtolower($product['description'])); ?>">
                  <div class="card product-card">
                     ...
                     <?php else: ?>
                     <img src="images/no-image.jpg" class="card-img-top product-img" alt="No Image Available">
                     <?php endif; ?>
                     <div class="card-body">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                searchInput.addEventListener('input', function() {
                    ...
                    productItems.forEach(item => {
                        ...
                        const productDesc = item.getAttribute('data-desc');
      ...
      <div id="enquiryPopup" class="popup-overlay">
         <div class="popup-content">
            ...
            <form id="enquiryForm" class="popup-form">
               ...
               <div class="form-group">
                  ...
                  <textarea id="popupAddress" name="address" rows="3"></textarea>
               </div>
      ...
      <script>
         // Show popup when "Send Address" is clicked or when page loads
         ...
         // Show popup when page loads (if not previously closed)
         document.addEventListener('DOMContentLoaded', function() {
         ...
         // Format the message
         const message = `New Address Enquiry:\n\n*Name:* ${name}\n*Phone:* ${phone}\n*Address:* ${address}\n\nPlease help me with directions or more information.`;
